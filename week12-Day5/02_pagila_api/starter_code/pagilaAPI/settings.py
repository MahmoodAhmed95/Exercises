"""
Django settings for pagilaAPI project.
...
SECRET_KEY = 'django-insecure-neye5v&8q#&f=v*&=kh-if$lnk_ltqb^gks_vc5f^v)te81l$9'
...
WSGI_APPLICATION = 'pagilaAPI.wsgi.application'
