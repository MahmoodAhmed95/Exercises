...
class Payment(models.Model):
    ...
    payment_date = models.DateTimeField(primary_key=True)  # The composite primary key (payment_date, payment_id) found, that is not supported. The first column is selected.
